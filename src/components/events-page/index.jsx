...
export default function EventsPage(){
    ...
    return(
        <div className="flex flex-col bg-gray-900 bg-[url('/csi-website.png')] bg-fixed">
            ...
            <img src="./images/zephrbanner.png" alt="zephyr-banner" className="object-cover hidden md:block w-auto h-1/2"/></div>
            <div className="text-white py-8 ">
                {/* <p className="text-center font-bold text-5xl my-8">ZEPHYR</p> */}
                <p className="mx-10 border-2 rounded border-gray-500 px-6 md:px-10 text-center text-sm md:text-base lg:text:lg xl:text-xl">Zephyr is a 3-day annual technical festival of Thakur College of Engineering and Technology. It was
          ...
          join us for Zephyr 2022-23, and experience the thrill yourself!</p>
            </div>
