  ...
  return (
    <div className="mx-auto text-white md:text-lg lg:text-3xl">
      <div className="relative  ">
        ...
        <div className="absolute top-0 right-0 py-2 px-1 rounded-bl-md rounded-tr-md bg-gradient-to-tr from-neutral-900 via-[#700880] to-neutral-900">
        ...
        <div className="absolute left-0 bottom-0 rounded-b-md p-1 lg:p-2 md:p-2 w-full bg-gradient-to-r from-neutral-900 via-[#650873] to-[#6c27777b]">
